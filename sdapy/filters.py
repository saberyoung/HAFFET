...
ab_to_vega={'V':-0.01,'B':-0.13,'U':1.02,'A':1.51,'D':1.69,'S':1.73,'White':0.80}
...
ys = {'F':-50,'S':-40,'D':-30,'N':-20,'A':-10,'u':0,'U':10,'B':20,
      ...
      'I':110,'z':120,'y':130,'J':140,'H':150,'K':160,'W':170,'Q':180}
...
PROP1f = {
    ...
    "R":dict(color='gold', marker='o', ls='none', fillstyle='none'),
    "B":dict(color='skyblue', marker='o', ls='none', fillstyle='none'),
    ...
    "S":dict(color='purple', marker='o', ls='none', fillstyle='none'),
    "D":dict(color='salmon', marker='o', ls='none', fillstyle='none'),
    "A":dict(color='pink', marker='o', ls='none', fillstyle='none'),
    "U":dict(color='grey', marker='o', ls='none', fillstyle='none'),
    "V":dict(color='magenta', marker='o', ls='none', fillstyle='none'),
    "H":dict(color='lime', marker='o', ls='none', fillstyle='none'),
    "J":dict(color='navy', marker='o', ls='none', fillstyle='none'),
    "K":dict(color='peru', marker='o', ls='none', fillstyle='none'),
    "Q":dict(color='violet', marker='o', ls='none', fillstyle='none'),
    "W":dict(color='gold', marker='o', ls='none', fillstyle='none'),  
}
...
PROP4 = {
    ...
    "R":dict(color='gold', ls='-', zorder=1),
    "B":dict(color='skyblue', ls='-', zorder=1),
    ...
    "S":dict(color='purple', ls='-', zorder=1),
    "D":dict(color='salmon', ls='-', zorder=1),
    "A":dict(color='pink', ls='-', zorder=1),
    "U":dict(color='grey', ls='-', zorder=1),
    "V":dict(color='magenta', ls='-', zorder=1),
    "H":dict(color='lime', ls='-', zorder=1),
    "J":dict(color='navy', ls='-', zorder=1),
    "K":dict(color='peru', ls='-', zorder=1),
    "Q":dict(color='violet', ls='-', zorder=1),
    "W":dict(color='gold', ls='-', zorder=1),
}
...
PROP6 = {
    ...
    "lyman_data_1":dict(color='k', fillstyle='none', marker = 'o',
                        ls='none', alpha=.5, label=None, zorder=3),
    ...
    "lyman_data_3":dict(color='b', fillstyle='none', marker = 'o',
                        ls='none', alpha=.5, label='Lyman', zorder=1),   
    ...
    "bb_data_3":   dict(color='b', fillstyle='none', marker = 's',
                        ls='none', alpha=.5, label='BB pseudo', zorder=1),
    ...
    "bb_data_3f":  dict(color='b', fillstyle='none', marker = 'v',
                        ls='none', alpha=.5, label='BB SB', zorder=1),
}
...
## for shock fits
PROP8 = {
    "fit":dict(color='orange',ls='--',zorder=5),
}

## for joint fits
PROP9 = {
    "fit":dict(color='grey',ls='--',zorder=6),
}
